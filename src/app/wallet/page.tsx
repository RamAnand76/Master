                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <Card className="bg-secondary/50 backdrop-blur-xl border-border/60 shadow-2xl transition-all duration-300 ease-in-out hover:transform hover:scale-[1.02] hover:shadow-primary/20 overflow-hidden">
                                ...
                                <CardContent>
                                    ...
                                    <Button className="mt-6 w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-3 px-6 rounded-lg text-base leading-normal tracking-wide shadow-lg transition-all duration-300 ease-in-out hover:transform hover:scale-105 hover:shadow-primary/40">
                                        Add More Credits
                                    </Button>
                                </CardContent>
                            </Card>
